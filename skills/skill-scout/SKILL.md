---
name: skill-scout
# Vendored into CPAS from ECC (MIT — affaan-m/ECC), itself salvaged from a community PR. Verbatim,
# scanned on intake 2026-06-15. version/updated are internal re-vendor tracking fields, not upstream's.
version: 1.0.0
updated: 2026-06-15
